# 1 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\leveldata.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\leveldata.c"
# 1 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/bank.h" 1
# 2 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\leveldata.c" 2
...
# 1 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/../leveldata1.c" 1
# 1 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/../source/level.h" 1



# 1 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/../source/stdint.h" 1
...
# 5 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/../source/level.h" 2
# 14 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/../source/level.h"
    enum SwatchType
    {
        SWATCH_TYPE_S,
        SWATCH_TYPE_H,
...
# 2 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\/../leveldata1.c" 2
    ...
    .fields =
        {
            &(const struct SwatchField){
                .action = SWATCH_FIELD_ACTION_SPLIT1,
                .position = {.x = 6, .y = 7},
            },
            &(const struct SwatchField){
                .action = SWATCH_FIELD_ACTION_SPLIT2,
                .position = {.x = 6, .y = 5},
            },
        }};
...
const struct Swatch const swatch_1_0 = {
    ...
    .fields =
        {
            &(const struct SwatchField){
                .action = SWATCH_FIELD_ACTION_OFF,
                .position = {.x = 3, .y = 6},
            },
        }};
...
const struct Swatch const swatch_1_3 = {
    ...
    .fields =
        {
            &(const struct SwatchField){
                .action = SWATCH_FIELD_ACTION_ONOFF,
                .position = {.x = 2, .y = 8},
            },
        }};
...
# 9 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\leveldata.c" 2
