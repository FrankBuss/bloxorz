...
;  0 "" 2
;  159 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;  0 "" 2
;  168 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;----- asm -----
;  255 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[175]    lineCount++;
;  0 "" 2
;--- end asm ---
	ldb	_lineCount	; , lineCount
...
;--- end asm ---
	...
	stb	,x	; , lineY1
;----- asm -----
;  266 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[181]    lineCount++;
;  0 "" 2
;--- end asm ---
...
L29:
;----- asm -----
;  403 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;--- end asm ---
	...
	stb	_lineX1,x	; , lineX1
;----- asm -----
;  211 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;--- end asm ---
	...
	bls	L39	; 
;----- asm -----
;  218 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;--- end asm ---
	...
	stb	_lineX1,x	; , lineX1
;----- asm -----
;  190 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;--- end asm ---
	...
	bls	L43	; 
;----- asm -----
;  198 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;--- end asm ---
	...
	jsr	_addLineImpl	; 
;----- asm -----
;  231 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[160]		x0 += test;
;  0 "" 2
;--- end asm ---
	ldb	6,s	; , ivtmp.152
...
;--- end asm ---
	...
	jsr	_addLineImpl	; 
;----- asm -----
;  238 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[164]		y0 += test;
;  0 "" 2
;--- end asm ---
	ldb	5,s	; , ivtmp.144
...
L48:
;----- asm -----
;  241 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
L55:
;----- asm -----
;  362 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[242]				y1 = y;
;  0 "" 2
;--- end asm ---
	ldb	2,s	; , y
...
;--- end asm ---
	...
	jsr	_addLine	; 
;----- asm -----
;  369 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[246]					y0 = -1;
;  0 "" 2
;--- end asm ---
	ldb	#-1	; ,
...
;--- end asm ---
	...
	bgt	L63	; 
;----- asm -----
;  301 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
;--- end asm ---
	...
	stb	_endX	; , endX
;----- asm -----
;  310 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[209]				endY = y;
;  0 "" 2
;--- end asm ---
	ldb	3,s	; , y
...
L67:
	...
	bne	L68	; 
;----- asm -----
;  316 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
L69:
	...
	bne	L66	; 
;----- asm -----
;  322 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
...
L72:
;----- asm -----
;  329 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[221]				x1 = x;
;  0 "" 2
;--- end asm ---
	ldb	1,s	; , x
...
;--- end asm ---
	...
	jsr	_addLine	; 
;----- asm -----
;  336 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[225]					x0 = -1;
;  0 "" 2
;--- end asm ---
	ldb	#-1	; ,
...
;--- end asm ---
	jsr	_setupX	; 
;----- asm -----
;  416 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[278]    setupY();
;  0 "" 2
;--- end asm ---
	jsr	_setupY	; 
...
;--- end asm ---
	...
	jsr	_isSwatchFieldOn	; 
	tstb	;  D.1390
	clra		;zero_extendqihi: R:b -> R:d	;  D.1390, tmp55
	addd	#-1	;  tmp56,
	tfr	a,b	; ,
	clra		;zero_extendqihi: R:b -> R:d	; ,
	rolb	; 
...
;--- end asm ---
	jsr	_setSplitMode	; 
;----- asm -----
;  136 "/home/frank/bin/Vide/../../data/projects/bloxorz/Vide/source/level.enr.c" 1
	; #ENR#[97]					break;
;  0 "" 2
;--- end asm ---
	bra	L85	; 
