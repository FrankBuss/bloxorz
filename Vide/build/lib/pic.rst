   ...
   C89A                       7 bit_counter: .blkb   1
                             ...
                             11 	.globl  _picWrite
   3041                      12 _picWrite:
   3041 34 1E         [ 9]   13 	pshs    d,dp,x
   3043 F7 C8 98      [ 5]   14 	stb data
                             15 
   3046 86 D0         [ 2]   16 	lda #0hd0		; setup direct page to 0xd000
   3048 1F 8B         [ 6]   17 	tfr a, dp
                             18 
   304A 8E 00 DF      [ 3]   19 	ldx #0xdf
   304D 10 8E 00 9F   [ 4]   20 	ldy #0x9f
                             21 
                             22 	; start with low signal
   3051 86 DF         [ 2]   23 	lda #0xdf
   3053 97 02         [ 4]   24 	sta *DCNTRL	; PB6 direction = output
                             25 
   3055 96 00         [ 4]   26 	lda *CNTRL
   3057 84 BF         [ 2]   27 	anda #0xbf
   3059 97 00         [ 4]   28 	sta *CNTRL
                             29 	
                             30 	; byte transfer starts with high signal
                             31 	; 1 bit needs 45 cycles (= 30 us)
                             32 	; bit 0 = 4 us high
                             33 	; bit 1 = 9.3 us high
   305B C6 08         [ 2]   34 	ldb #8
   305D                      35 loop:
   305D B6 C8 98      [ 5]   36 	lda data
   3060 85 80         [ 2]   37 	bita #0x80
   3062 27 0E         [ 3]   38 	beq loop2
   3064 86 9F         [ 2]   39 	lda #0x9f
   3066 97 02         [ 4]   40 	sta *DCNTRL	; PB6 direction = input
   3068 12            [ 2]   41 	nop
   3069 12            [ 2]   42 	nop
   306A 12            [ 2]   43 	nop
   306B 12            [ 2]   44 	nop
   306C 86 DF         [ 2]   45 	lda #0xdf
   306E 97 02         [ 4]   46 	sta *DCNTRL	; PB6 direction = output
   3070 20 0E         [ 3]   47 	bra loop3
   3072                      48 loop2:
   3072 86 9F         [ 2]   49 	lda #0x9f
   3074 97 02         [ 4]   50 	sta *DCNTRL	; PB6 direction = input
   3076 86 DF         [ 2]   51 	lda #0xdf
   3078 97 02         [ 4]   52 	sta *DCNTRL	; PB6 direction = output
   307A 12            [ 2]   53 	nop
   307B 12            [ 2]   54 	nop
   307C 12            [ 2]   55 	nop
   307D 12            [ 2]   56 	nop
   307E 20 00         [ 3]   57 	bra loop3
   3080                      58 loop3:
   3080 78 C8 98      [ 7]   59 	lsl data
   3083 5A            [ 2]   60 	decb
   3084 26 D7         [ 3]   61 	bne loop
                             62 
                             63 ; wait a bit at the end of the transfer
   3086 C6 0A         [ 2]   64 	ldb #10
   3088                      65 loop4:
   3088 5A            [ 2]   66 	decb
   3089 26 FD         [ 3]   67 	bne loop4
                             68 
   308B 35 9E         [10]   69 	puls d,dp,x,pc       ; restore registers from stack and return
                             70 
                             71 
                             72 
                             73 
                             74 	.globl  _picRead
   308D                      75 _picRead:
   308D 34 1E         [ 9]   76 	pshs    d,dp,x
                             77 
   308F 86 D0         [ 2]   78 	lda #0hd0		; setup direct page to 0xd000
   3091 1F 8B         [ 6]   79 	tfr a, dp
                             80 
                             81 ; set PB6 to high
   3093 86 9F         [ 2]   82 	lda #0x9f
   3095 97 02         [ 4]   83 	sta *DCNTRL	; PB6 direction = input
                             84 
                             85 ; wait a bit until the signal settles
   3097 C6 0A         [ 2]   86 	ldb #10
   3099                      87 wh:
   3099 5A            [ 2]   88 	decb
   309A 26 FD         [ 3]   89 	bne wh
                             90 
   309C 86 08         [ 2]   91 	lda #8
   309E B7 C8 9A      [ 5]   92 	sta bit_counter
                             93 
                             94 ; wait until PB6 is set to low from the PIC
   30A1 86 00         [ 2]   95 	lda #0
   30A3 B7 C8 98      [ 5]   96 	sta data
   30A6 C6 40         [ 2]   97 	ldb #0h40
   30A8                      98 wait_start:
   30A8 4C            [ 2]   99 	inca
   30A9 81 FF         [ 2]  100 	cmpa #255
   30AB 27 37         [ 3]  101 	beq timeout
   30AD D5 00         [ 4]  102 	bitb *CNTRL
   30AF 26 F7         [ 3]  103 	bne wait_start
                            104 
                            105 ; measure high time
   30B1                     106 next_bit:
   30B1 86 00         [ 2]  107 	lda #0
   30B3 B7 C8 99      [ 5]  108 	sta counter
   30B6 C6 40         [ 2]  109 	ldb #0h40
   30B8                     110 wait_start2:
   30B8 4C            [ 2]  111 	inca
   30B9 81 FF         [ 2]  112 	cmpa #255
   30BB 27 27         [ 3]  113 	beq timeout
   30BD D5 00         [ 4]  114 	bitb *CNTRL
   30BF 27 F7         [ 3]  115 	beq wait_start2
   30C1 86 00         [ 2]  116 	lda #0
   30C3                     117 wait_start3:
   30C3 4C            [ 2]  118 	inca
   30C4 81 FF         [ 2]  119 	cmpa #255
   30C6 27 1C         [ 3]  120 	beq timeout
   30C8 7C C8 99      [ 7]  121 	inc counter
   30CB D5 00         [ 4]  122 	bitb *CNTRL
   30CD 26 F4         [ 3]  123 	bne wait_start3
                            124 
                            125 ; test if it was a 0 or 1 bit
   30CF F6 C8 99      [ 5]  126 	ldb counter
   30D2 B6 C8 98      [ 5]  127 	lda data
   30D5 48            [ 2]  128 	asla
   30D6 C1 09         [ 2]  129 	cmpb #9
   30D8 2D 02         [ 3]  130 	blt less
   30DA 8A 01         [ 2]  131 	ora #1
   30DC                     132 less:
   30DC B7 C8 98      [ 5]  133 	sta data
                            134 
   30DF 7A C8 9A      [ 7]  135 	dec bit_counter
   30E2 26 CD         [ 3]  136 	bne next_bit
                            137 
   30E4                     138 timeout:
                            139 
                            140 ; return high time
   30E4 35 1E         [ 9]  141 	puls d,dp,x       ; restore registers from stack
   30E6 F6 C8 98      [ 5]  142 	ldb data
   30E9 39            [ 5]  143 	rts
                            144 
                            145 
   ...
   30EA                     148 _delay10ms:
   30EA 34 1E         [ 9]  149 	pshs    d,dp,x
                            150 
   30EC 86 0C         [ 2]  151     lda #12
   30EE C6 00         [ 2]  152 d1:    ldb #0
   30F0 5A            [ 2]  153 d2:    decb
   30F1 26 FD         [ 3]  154     bne d2
   30F3 4A            [ 2]  155     deca
   30F4 26 F8         [ 3]  156     bne d1
                            157 
   30F6 35 9E         [10]  158 	puls d,dp,x,pc       ; restore registers from stack and return
