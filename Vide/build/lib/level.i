...
# 178 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\level.c"
int8_t last_x = -1;
int8_t last_y = -1;
int8_t last_s = -1;
...
void checkHalfling()
{
    ...
    if (last_s != -1)
    {
        ...
        else if ((oldSacle == (((int8_t)((((((int8_t)(((0x7f)) >> 1)) + ((int8_t)(0)))) >> 1))) + ((int8_t)(0)))) && (useHalfling[levelOffset + levelNumber] > 1))
        {
            int16_t dy = lineYX_yx_s_dy_dx[(uint16_t)((uint16_t)(lineCount)*5 + 0)] - last_y;
            int16_t dx = lineYX_yx_s_dy_dx[(uint16_t)((uint16_t)(lineCount)*5 + 1)] - last_x;
            dy = dy << 1;
        ...
        else if ((oldSacle == (((int8_t)((((((int8_t)((((((int8_t)(((0x7f)) >> 1)) + ((int8_t)(0)))) >> 1))) + ((int8_t)(0)))) >> 1))) + ((int8_t)(0)))) && (useHalfling[levelOffset + levelNumber] > 2))
        {
            int16_t dy = lineYX_yx_s_dy_dx[(uint16_t)((uint16_t)(lineCount)*5 + 0)] - last_y;
            int16_t dx = lineYX_yx_s_dy_dx[(uint16_t)((uint16_t)(lineCount)*5 + 1)] - last_x;
            dy = dy << 1;
...
# 407 "C:\\data\\Vide\\..\\bloxorz\\Vide\\source\\level.c"
void setupX()
{
    long int index;
    int8_t x = 0;
