namespace Bloxorz
{
    public class E6809
    {
        //code adapted from https://github.com/jhawthorn/vecx/blob/master/e6809.c

        public CPUBus bus;

        public const int FLAG_E = 0x80;
        public const int FLAG_F = 0x40;
        public const int FLAG_H = 0x20;
        public const int FLAG_I = 0x10;
        public const int FLAG_N = 0x08;
        public const int FLAG_Z = 0x04;
        public const int FLAG_V = 0x02;
        public const int FLAG_C = 0x01;
        public const int IRQ_NORMAL = 0;
        public const int IRQ_SYNC = 1;
        public const int IRQ_CWAI = 2;

        //registers
        public int reg_x; //index
        public int reg_y;
        public int reg_u; //stack pointer
        public int reg_s;
        public int reg_pc; //program counter
        public int reg_a; //accumulator
        public int reg_b;
        public int reg_dp; //direct page
        public int reg_cc; //condition codes
        public int irq_status; //interrupt flag

        private int tmp16; //should remain unused
        public ref int rptr_xyus(int i)
        {
            //alias the code uses
            switch (i)
            {
                ...
                default: //shouldn't ever happen
                    System.Console.WriteLine("rptr_xyus returned tmp16");
                    return ref tmp16;
            }
        }

        public E6809(CPUBus b)
        {
            bus = b;
        }
        ...
        public int sstep(int irq_i, int irq_f)
        {
        ...
        /* code assumptions:
			 ...
			 *
				# include <stdio.h>
		# include "e6809.h" may contain garbage!
        ...
        {
            return bus.read8((ushort)(address & 0xffff));
        }
        ...
        {
            bus.write8((ushort)(address & 0xffff), (byte)data);
        }
        ...
        void push8(ref int sp, int data)
        {
            sp--;
            write8(sp, data);
        }

        int pull8(ref int sp)
        {
            int data;
        ...
        void push16(ref int sp, int data)
        {
            push8(ref sp, data);
            push8(ref sp, data >> 8);
        }

        int pull16(ref int sp)
        {
            int datahi, datalo;
        ...
        int ea_indexed(ref int cycles)
        {
            ...
            switch (op)
            {
                ...
                case 0x9f:
                    ...
                    break;
                default:
                    System.Console.WriteLine("undefined post-byte\n");
                    break;
            }
        ...
        void inst_bra8(int test, int op, ref int cycles)
        {
            int offset, mask;
        ...
        void inst_bra16(int test, int op, ref int cycles)
        {
            int offset, mask;
        ...
        void inst_psh(int op, ref int sp,
                int data, ref int cycles)
        {
            if ((op & 0x80) != 0)
            {
                push16(ref sp, reg_pc);
                cycles += 2;
            }
        ...
        void inst_pul(int op, ref int sp, ref int osp,
                ref int cycles)
        {
            if ((op & 0x01) != 0)
            {
        ...
        int exgtfr_read(int reg)
        {
            ...
            switch (reg)
            {
                ...
                default:
                    data = 0xffff;
                    System.Console.WriteLine("illegal exgtfr reg " + reg);
                    break;
            }
        ...
        int e6809_sstep(int irq_i, int irq_f)
        {
            ...
            if (irq_f != 0)
            {
                if (get_cc(FLAG_F) == 0)
                {
                    ...
                    {
                        set_cc(FLAG_E, 0);
                        inst_psh(0x81, ref reg_s, reg_u, ref cycles);
                    }
            ...
            if (irq_i != 0)
            {
                if (get_cc(FLAG_I) == 0)
                {
                    ...
                    {
                        set_cc(FLAG_E, 1);
                        inst_psh(0xff, ref reg_s, reg_u, ref cycles);
                    }
            ...
            switch (op)
            {
                ...
                /* leax */
                case 0x30:
                    reg_x = ea_indexed(ref cycles);
                    set_cc(FLAG_Z, test_z16(reg_x));
                    cycles += 4;
                    break;
                /* leay */
                case 0x31:
                    reg_y = ea_indexed(ref cycles);
                    set_cc(FLAG_Z, test_z16(reg_y));
                    cycles += 4;
                    break;
                /* leas */
                case 0x32:
                    reg_s = ea_indexed(ref cycles);
                    cycles += 4;
                    break;
                /* leau */
                case 0x33:
                    reg_u = ea_indexed(ref cycles);
                    cycles += 4;
                    break;
                /* pshs */
                case 0x34:
                    inst_psh(pc_read8(), ref reg_s, reg_u, ref cycles);
                    cycles += 5;
                    break;
                /* puls */
                case 0x35:
                    inst_pul(pc_read8(), ref reg_s, ref reg_u, ref cycles);
                    cycles += 5;
                    break;
                /* pshu */
                case 0x36:
                    inst_psh(pc_read8(), ref reg_u, reg_s, ref cycles);
                    cycles += 5;
                    break;
                /* pulu */
                case 0x37:
                    inst_pul(pc_read8(), ref reg_u, ref reg_s, ref cycles);
                    cycles += 5;
                    break;
                /* rts */
                case 0x39:
                    reg_pc = pull16(ref reg_s);
                    cycles += 5;
                    break;
                /* abx */
                case 0x3a:
                ...
                case 0x3b:
                    if (get_cc(FLAG_E) != 0)
                    {
                        inst_pul(0xff, ref reg_s, ref reg_u, ref cycles);
                    }
                    else
                    {
                        inst_pul(0x81, ref reg_s, ref reg_u, ref cycles);
                    }
                ...
                case 0x10:
                    ...
                    switch (op)
                    {
                        ...
                        case 0x3f:
                            ...
                            break;
                        default:
                            System.Console.WriteLine("unknown page-1 op code: " + op);
                            break;
                    }
                ...
                case 0x11:
                    ...
                    switch (op)
                    {
                        ...
                        case 0x3f:
                            ...
                            break;
                        default:
                            System.Console.WriteLine("unknown page-2 op code: " + op);
                            break;
                    }
                ...
                default:
                    System.Console.WriteLine("unknown page-0 op code: " + op);
                    break;
            }
