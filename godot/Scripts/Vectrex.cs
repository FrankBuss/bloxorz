...
namespace Bloxorz
{
    public class Vectrex : CPUBus
    {
        //code adapted from: https://github.com/jhawthorn/vecx/blob/master/vecx.c

        // called for writes to 0x8000 (VECX_MUSIC): 0-4 = sound effects
        ...
        public List<VectorT> lines_last_frame = new List<VectorT>();
        ...
        private const int VECX_MUSIC = 0x8000;
        private const int VECX_PIC_RW = 0x8001;
        private byte cmd;
        ...
        /* the lines of the last complete frame, captured at the BIOS Wait_Recal call */
        public List<VectorT> vecx_lines()
        {
